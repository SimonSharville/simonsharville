...
(function($) {
    ...
    ShareBar = function(element) {
        var self = this,
            ...
            share_title = '',
            open = 'false',
            themes = ['gradient','flat','light','dark', 'simon'];
        ...
        if($(me).attr('data-theme'))
            theme = $(me).attr('data-theme').toLowerCase();
        ...
        init = function() {
            ...
            $(me).addClass(style).addClass('sss-'+theme);
